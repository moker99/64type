 ...
 * 
 * 維度定義：
 * 1. EI: 能量獲取 (Extraversion 外向 vs Introversion 內向) - 10題
 * 2. SN: 資訊感知 (Sensing 實感 vs Intuition 直覺) - 10題
 * 3. TF: 決策邏輯 (Thinking 理智 vs Feeling 情感) - 10題
 * 4. JP: 生活處事 (Judging 條理 vs Perceiving 靈活) - 10題
 * 5. AR: 心態韌性 (Assertive 篤定自信 vs Reflective 審慎敏銳) - 10題
 * 6. DC: 行動驅力 (Driver 開拓主導 vs Connective 協同共鳴) - 10題
 */
