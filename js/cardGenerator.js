 ...
 * 使用 Canvas 繪製高畫質 1080x1600 社交分享海報，支援一鍵下載 PNG 與複製至剪貼簿
 */
...
class ShareCardGenerator {
  ...
  static async generateCardDataUrl(result) {
    ...
    ctx.fillText("https://64type.personality.app", width / 2, 1515);
